# sdk.types.error_span

## Classes

| [`ErrorSpan`](#sdk.types.error_span.ErrorSpan)   | Character-level span within validated text that caused a validation failure.   |
|--------------------------------------------------|--------------------------------------------------------------------------------|

## Module Contents

### *class* sdk.types.error_span.ErrorSpan(/, \*\*data: Any)
