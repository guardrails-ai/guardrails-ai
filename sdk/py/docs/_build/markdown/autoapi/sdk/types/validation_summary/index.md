# sdk.types.validation_summary

## Classes

| [`ValidationSummary`](#sdk.types.validation_summary.ValidationSummary)   | Per-validator result produced during a Guard execution.   |
|--------------------------------------------------------------------------|-----------------------------------------------------------|

## Module Contents

### *class* sdk.types.validation_summary.ValidationSummary(/, \*\*data: Any)
