...
| [`Validator`](#sdk.types.validator.Validator)   | A validator attached to a Guard, including its configuration.   |
|-------------------------------------------------|-----------------------------------------------------------------|

## Module Contents

### *class* sdk.types.validator.Validator(/, \*\*data: Any)
...
#### on_fail *: guardrails_ai.sdk.types.on_fail.OnFail | [None](https://docs.python.org/3/library/constants.html#None)* *= None*
